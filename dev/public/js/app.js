...
alpinejs__WEBPACK_IMPORTED_MODULE_0__["default"].start(); // Importación de sweet alert 2


window.Swal = (sweetalert2__WEBPACK_IMPORTED_MODULE_1___default()); // Código para notificaciones toast



window.Notyf = new notyf__WEBPACK_IMPORTED_MODULE_2__.Notyf({
  types: [{
    type: 'success',
